...
type LiveAudioQueryTaskIdV1Req struct {
...
func NewLiveAudioQueryTaskIdV1Req(businessId string) *LiveAudioQueryTaskIdV1Req {
	var request = &LiveAudioQueryTaskIdV1Req{
		BizPostFormRequest: types.NewBizPostFormRequest(businessId),
	}
	request.SetProductCode("liveAudio")
	request.SetUriPattern("/v1/liveaudio/query/task")
	request.SetVersion("v1")
	return request
}

// 定义 GetCustomSignParams() 方法的功能
func (req *LiveAudioQueryTaskIdV1Req) GetBusinessCustomSignParams() map[string]string {
