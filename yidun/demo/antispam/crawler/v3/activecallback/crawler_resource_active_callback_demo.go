...
func handleCallback(w http.ResponseWriter, r *http.Request) {
	...
	//签名验证通过
	if verifyResult {
		callbackRequest := callback.NewCrawlerResourceActiveCallbackV3Request(params)
		// 解析得到网站检测结果
		// 根据需要解析字段，具体返回字段的说明，请参考官方接口文档中字段说明 https://support.dun.163.com/documents/606191408732381184?docId=606214890950840320
		result := &callback.CrawlerResourceResult{}
