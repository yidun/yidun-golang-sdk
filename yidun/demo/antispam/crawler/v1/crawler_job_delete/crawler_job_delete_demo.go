 ...
 */
func main() {
	// 构造CrawlerJobDeleteV1Request请求对象
	request := delete.NewCrawlerJobDeleteV1Request()

	request.SetJobIds([]int64{1761662145517619, 1761662145518130})
	...
	response, err := crawlerSubmitClient.CrawlerJobDelete(request)
	if err != nil {
		// 处理错误并打印日志
		log.Fatal(err)
	}
