...
import (
	...
	text_v5 "github.com/yidun/yidun-golang-sdk/yidun/service/antispam/text/v5/callback"
 ...
 */
func main() {
	http.HandleFunc("/callback/receive/text", handleCallback) //设置主动回调url
